...
public class MpgCalculationResultsTests{
	...
	{
		results.addCostFactor(new MpgCostFactor(NmdLifeCycleStage.Transport, NmdImpactFactor.AbioticDepletionFuel, "concrete" , 1.0));
	...
	public void testCanCollectResultsByStage() {
		addFactorsTestSet();
		assertEquals(3.0, results.getCostPerLifeCycle(NmdLifeCycleStage.Transport), 1e-8);
	}
	...
	private void addFactorsTestSet() {
		results.addCostFactor(new MpgCostFactor(NmdLifeCycleStage.Transport, NmdImpactFactor.Acidifcation, "concrete" , 1.0));
		results.addCostFactor(new MpgCostFactor(NmdLifeCycleStage.Transport, NmdImpactFactor.AbioticDepletionFuel, "brick" , 2.0));
